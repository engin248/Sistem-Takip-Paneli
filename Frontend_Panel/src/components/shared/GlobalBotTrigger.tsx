  ...
  return (
    <>
      ...
      <button 
        ...
        className="fixed bottom-6 right-6 z-[9999] w-14 h-14 bg-rose-600 rounded-full flex items-center justify-center cursor-pointer shadow-[0_0_20px_rgba(6,182,212,0.4)] hover:bg-rose-500 hover:scale-105 active:scale-95 transition-all group"
      >
      ...
      >
        <div className="bg-[#111827] px-4 py-3 border-b border-white/5 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-black text-rose-400 tracking-widest uppercase truncate max-w-[200px]">
              {screenId} DİREKT HAT
            </span>
          </div>
          <div className="flex gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-amber-500 animate-pulse" title="Asil Ajan"></span>
        ...
        <div className="p-4 flex-1 bg-transparent">
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/5 p-3 flex flex-col gap-3">
              <textarea
                value={cmd}
              ...
              <div className="flex justify-between items-center border-t border-white/5 pt-2 mt-2">
                  <span className="text-[8px] font-black text-amber-600 uppercase tracking-widest">● HAZIR</span>
                  <button 
                    onClick={handleSend}
                    disabled={!cmd.trim()}
                    className="px-4 py-2 bg-rose-600/20 text-rose-400 border border-rose-500/20 text-[9px] font-black uppercase tracking-widest hover:bg-rose-500/30 disabled:opacity-30 transition-all flex items-center gap-2"
                  >
