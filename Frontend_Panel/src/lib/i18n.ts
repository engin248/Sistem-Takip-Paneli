...
export const translations = {
  tr: {
    ...
    sealSystem: 'SİSTEMİ onayLE (JSON)',
    sealing: 'onaylama...',
    ...
    boardSubtitle: 'Konsensüs onay Mekanizması',
    ...
    boardStatusSealed: 'onayLÜ',
    boardConsensusSealed: '✅ KONSENSÜS SAĞLANDI — ONAYLANDI',
