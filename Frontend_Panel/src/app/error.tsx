  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white/5 backdrop-blur-md text-white p-8">
      <div className="max-w-md text-center space-y-6">
        ...
        <div className="bg-black/20/50 p-4 border border-red-500/20">
        ...
        <button
          onClick={reset}
          className="bg-rose-500 text-white text-[10px] font-black px-8 py-3 rounded-none hover:bg-rose-600 transition-all uppercase tracking-widest shadow-[0_0_15px_rgba(6,182,212,0.3)]"
        >
          SİSTEMİ YENİLE
        </button>
      </div>
