...
// GET /api/rules → Sistem Kuralları v2.1 — 40 kural, 9 kategori
// ============================================================
...
const KURALLAR = [
  ...
  { no: 'Ö-004', kategori: 'ÖĞRENME', ihlal: 'IPTAL', kural: 'TEKRARLAMA', aciklama: 'Aynı hatayı iki kez yapma. İlk hata öğretir, ikinci hata ihmal.' },
];
