    ...
    <div className="relative">
      ...
      {showMenu && (
        <>
          ...
          {/* Panel */}
          <div
            className={`absolute top-full mt-2 z-50 w-64 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl shadow-2xl overflow-hidden ${
