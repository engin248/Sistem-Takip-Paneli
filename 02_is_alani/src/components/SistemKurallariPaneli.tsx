...
// SCR-15 NÄ°ZAMNAME PANELÄ° â€” gerÃ§ek agentRules ÅŸemasÄ±na uygun
...
export default function SİSTEM_KURALLARIPaneli() {
  ...
  if (loading) return (
    <div className="flex items-center gap-2 py-8 justify-center">
      ...
      <span className="text-[9px] font-mono text-purple-400 tracking-[0.2em]">NÄ°ZAMNAME YÃœKLENÄ°YOR...</span>
    </div>
  );
  if (error) return (
  ...
  if (!data) return <div className="text-red-400 text-xs font-mono py-4">âŒ Kurallar yÃ¼klenemedi</div>;
  ...
  return (
    <div className="space-y-4">
      ...
      {/* â”€â”€ BaÅŸlÄ±k + Ä°statistik â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <div className="flex flex-wrap items-center gap-3">
        <div className="flex items-center gap-2">
          <span className="text-xl">ğŸ“œ</span>
          <div>
            <div className="text-[10px] font-black tracking-[0.2em] uppercase text-purple-400">NÄ°ZAMNAME</div>
        ...
        <div className="ml-auto flex gap-2 flex-wrap">
          {[
            ...
            { l: 'Ã‡ALIÅMA',  v: calisma.adet,            c: 'text-blue-400'   },
          ].map(s => (
      ...
      {/* â”€â”€ Arama â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <input
        type="text"
        placeholder="No, kural veya aÃ§Ä±klama ara..."
        value={aramaMetni}
      ...
      {/* â”€â”€ Kategori Filtreleri â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      ...
      {/* â”€â”€ Kural Listesi â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <div className="space-y-3 max-h-[460px] overflow-y-auto pr-1">
        {filtreliKurallar.length === 0 && (
          <div className="text-slate-600 text-xs font-mono italic text-center py-8">EÅŸleÅŸen kural bulunamadÄ±.</div>
        )}
                  ...
                  return (
                    <div key={k.no} className={`rounded-lg border ${cfg.border} ${cfg.bg} px-3 py-2.5 flex items-start gap-3`}>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {k.kaynak && (
                          <div className="text-[7px] text-slate-600 font-mono mt-1">â†— {k.kaynak}</div>
                        )}
                      </div>
                      {/* Ä°hlal sonucu */}
