// ============================================================
// AGENT REGISTRY — 50 KİŞİLİK HİBRİT KADRO
// ============================================================
// 4 Komuta + 10 L1 İcraatçı + 6 L2 Denetçi + 2 L3 Hakem
// + 28 Destek Uzmanı = 50 Ajan
//
// Katman hiyerarşisi:
//   KOMUTA → Strateji, karar, güvenlik, koordinasyon
//   L1     → Doğrudan icraat (kod, DB, bot, AI, test, güvenlik...)
//   L2     → Denetim, doğrulama, kalite kontrolü
//   L3     → Hakem, çelişki çözümü, nihai karar
//   DESTEK → Altyapı, otomasyon, hafıza, iletişim, analitik
//
// Hata Kodları:
...
const DEFAULT_ROSTER: AgentCard[] = [
  ...
  },
  {
    ...
    katman: 'L2',
    beceri_listesi: ['erisim_analizi', 'kullanilabilirlik', 'wcag_uyumu', 'renk_kontrastı', 'navigasyon_analizi', 'responsive_kontrol'],
  ...
  // ══════════════════════════════════════════════════════════
  // L3 HAKEM AJANLAR (2) — Nihai Karar ve Çelişki Çözümü
  // ══════════════════════════════════════════════════════════
  ...
  },
  {
    ...
    rol: 'Çok dilli destek — i18n, TR/EN/AR çeviri, RTL uyumu, yerelleştirme',
    katman: 'DESTEK',
  ...
  },
  {
    ...
    rol: 'Çatışma çözümü — versiyon çakışması, merge conflict, anlaşmazlık yönetimi',
    katman: 'DESTEK',
  ...
  },
  {
    ...
    rol: 'Ölçüm ve izleme — sistem metrikleri, uptime, SLA takibi, kapasite planı',
    katman: 'DESTEK',
